...
class HeadHunterAPI(VacancyAPI):
    ...
    def __init__(self, pages: int = 5, per_page: int = 20):
        """Инициализирует экземпляр класса с параметрами страниц и вакансий на страницу.

                Args:
                    pages (int, optional): Количество страниц для загрузки. По умолчанию 5.
                    per_page (int, optional): Количество вакансий на страницу. По умолчанию 20.
                """
        self.pages = pages
    ...
    def base_url(self) -> str:
        """Возвращает базовый URL для API hh.ru.

                Returns:
                    str: Базовый URL API hh.ru.
                """
    ...
    def format_vacancy_data(vacancy: Dict) -> Dict:
        ...
        return {
            ...
            "currency": (vacancy.get("salary") or {}).get("currency", "RUR"),  # RUB по умолчанию,
